class Api::V1::SocialLinkSegmentsController < ApplicationController
  before_action :set_api_v1_social_link_segment, only: [:show, :edit, :update, :destroy]

  # GET /api/v1/social_link_segments
  # GET /api/v1/social_link_segments.json
  def index
    @api_v1_social_link_segments = Api::V1::SocialLinkSegment.all
  end

  # GET /api/v1/social_link_segments/1
  # GET /api/v1/social_link_segments/1.json
  def show
  end

  # GET /api/v1/social_link_segments/new
  def new
    @api_v1_social_link_segment = Api::V1::SocialLinkSegment.new
  end

  # GET /api/v1/social_link_segments/1/edit
  def edit
  end

  # POST /api/v1/social_link_segments
  # POST /api/v1/social_link_segments.json
  def create
  ...
  # PATCH/PUT /api/v1/social_link_segments/1
  # PATCH/PUT /api/v1/social_link_segments/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /api/v1/social_link_segments/1
  # DELETE /api/v1/social_link_segments/1.json
  def destroy
  ...
  private
    ...
    def set_api_v1_social_link_segment
      @api_v1_social_link_segment = Api::V1::SocialLinkSegment.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def api_v1_social_link_segment_params
      params.fetch(:api_v1_social_link_segment, {})
    end
end
